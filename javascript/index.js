...
// Bonus 2 - Promise all
let p0 = document.querySelector("#brusselsSproutsImg").removeAttribute("hidden")
...
let p9 = document.querySelector("#brusselsSprouts").innerHTML += `<li>Brussels sprouts are ready!.</li>` 
